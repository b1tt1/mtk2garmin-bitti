...
time java -jar -Xmx10G splitter.jar --output-dir=/splitted --max-areas=4096 --max-nodes=3200000 --resolution=14 /convertedpbf/all_osm.osm.pbf
...
time java -jar -Xmx10G mkgmap.jar -c /splitted/mkgmap_mtk2garmin_noparcel.args perus.typ
