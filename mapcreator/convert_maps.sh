...
echo "Splitting file..."
# BITTI: java -jar -Xmx10G mkgmap/splitter.jar --output-dir=splitted --max-areas=1024 --max-nodes=600000 all_osm.osm.pbf
java -jar mkgmap/splitter.jar --output-dir=splitted --max-areas=1024 --max-nodes=600000 all_osm.osm.pbf
echo "Splitting done"
...
# BITTI: java -jar -Xmx10G mkgmap/mkgmap.jar -c splitted/mkgmap_mtk2garmin.args perus.typ
java -jar mkgmap/mkgmap.jar -c splitted/mkgmap_mtk2garmin.args perus.typ

echo "Compiling garmin img noparcels"
# BITTI: java -jar -Xmx10G mkgmap/mkgmap.jar -c splitted/mkgmap_mtk2garmin_noparcel.args perus.typ
java -jar mkgmap/mkgmap.jar -c splitted/mkgmap_mtk2garmin_noparcel.args perus.typ
